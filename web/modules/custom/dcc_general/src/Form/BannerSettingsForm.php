...
class BannerSettingsForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'dcc_general_banner_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return ['dcc_general.banner_settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['banner_title'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Title'),
      '#default_value' => $this->config('dcc_general.banner_settings')->get('banner_title'),
    ];
    $form['banner_description'] = [
      '#type' => 'textarea',
      '#format' => 'full_html',
      '#title' => $this->t('Description'),
      '#default_value' => $this->config('dcc_general.banner_settings')->get('banner_description'),
    ];
    $form['banner_button_title'] = [
      '#type' => 'textfield',
      '#title' => $this->t('Button Title'),
      '#default_value' => $this->config('dcc_general.banner_settings')->get('banner_button_title'),
    ];
    $form['banner_button_link'] = [
      '#type' => 'url',
      '#title' => $this->t('Button link'),
      '#default_value' => $this->config('dcc_general.banner_settings')->get('banner_button_link'),
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('dcc_general.banner_settings')
